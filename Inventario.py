...
# INTERFAZ  DE USUARIO PARA MOSTRAR EL MENÚ DE OPCIONES Y SOLICITAR LA SELECCIÓN DEL USUARIO.
    ...
    if opcion == 1: # SI EL USUARIO SELECCIONA LA OPCIÓN 1, INICIA EL PROCESO PARA AGREGAR UN NUEVO PRODUCTO AL INVENTARIO.
        agregar_producto() # LLAMA A LA FUNCIÓN PARA AGREGAR UN PRODUCTO AL INVENTARIO.
        

    elif opcion == 2:
        mostrar_inventario() # LLAMA A LA FUNCIÓN PARA MOSTRAR EL INVENTARIO ACTUAL AL USUARIO.

    elif opcion == 3:
        calcular_estadisticas() # LLAMA A LA FUNCIÓN PARA CALCULAR Y MOSTRAR LAS ESTADÍSTICAS DEL INVENTARIO AL USUARIO.
